...
def download_plugins():
    ...
    for plugin in plugins:
        if path.exists(path.join(args.dirPath, plugin)):
            print('Plugin ' + plugin + ' already installed.')
        else:
            os.system('git clone ' + plugin + ' ' + path.join(args.dirPath, plugin))
...
if __name__ == '__main__':
    ...
    parser.add_argument('action', metavar='ACTION', action='store', help='Action to take.')
