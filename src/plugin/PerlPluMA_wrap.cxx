...
#define SWIG_init    boot_PerlPluMA

#define SWIG_name   "PerlPluMAc::boot_PerlPluMA"
#define SWIG_prefix "PerlPluMAc::"
...
void dependency(char *);
#ifdef __cplusplus
extern "C" {
#endif

#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_PerlPluMA_var::
class _wrap_PerlPluMA_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
extern "C" {
#endif
XS(_wrap_log) { { char *arg1 = (char *) 0 ; int res1 ; char *buf1 = 0 ; int alloc1 = 0 ; int argvi = 0; dXSARGS;
    if ((items < 1) || (items > 1)) { SWIG_croak("Usage: log(msg);"); } 
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1); if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "log" "', argument " "1"" of type '" "char *""'"); } 
    arg1 = reinterpret_cast< char * >(buf1); log(arg1); ST(argvi) = &PL_sv_undef; if (alloc1 == SWIG_NEWOBJ) delete[] buf1;
    XSRETURN(argvi); fail: if (alloc1 == SWIG_NEWOBJ) delete[] buf1; SWIG_croak_null(); }  }
XS(_wrap_dependency) { { char *arg1 = (char *) 0 ; int res1 ; char *buf1 = 0 ; int alloc1 = 0 ; int argvi = 0; dXSARGS;
    if ((items < 1) || (items > 1)) { SWIG_croak("Usage: dependency(plugin);"); } 
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1); if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "dependency" "', argument " "1"" of type '" "char *""'"); } 
    arg1 = reinterpret_cast< char * >(buf1); dependency(arg1); ST(argvi) = &PL_sv_undef;
    if (alloc1 == SWIG_NEWOBJ) delete[] buf1; XSRETURN(argvi); fail: if (alloc1 == SWIG_NEWOBJ) delete[] buf1;
    SWIG_croak_null(); }  }
...
{"PerlPluMAc::log", _wrap_log},
{"PerlPluMAc::dependency", _wrap_dependency},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
