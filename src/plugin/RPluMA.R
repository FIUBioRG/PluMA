...
##	 swig -r -c++ -addextern -small -fcompact -templatereduce -O RPluMA.i
...
# Start of log
`log` = function(msg) { msg = as(msg, "character");  ;.Call('R_swig_log', msg, PACKAGE='RPluMA'); }
attr(`log`, 'returnType') = 'void'
attr(`log`, "inputTypes") = c('character')
class(`log`) = c("SWIGFunction", class('log'))

# Start of dependency
`dependency` = function(plugin) { plugin = as(plugin, "character");  ;.Call('R_swig_dependency', plugin, PACKAGE='RPluMA'); }
