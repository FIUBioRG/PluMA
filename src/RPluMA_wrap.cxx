...
SWIGEXPORT SEXP R_swig_log ( SEXP msg) { char *arg1 = (char *) 0 ; unsigned int r_nprotect = 0; SEXP r_ans = R_NilValue ;
  VMAXTYPE r_vmax = vmaxget() ; arg1 = reinterpret_cast< char * >(SWIG_strdup(CHAR(STRING_ELT(msg, 0)))); log(arg1);
  r_ans = R_NilValue; free(arg1); vmaxset(r_vmax); if(r_nprotect)  Rf_unprotect(r_nprotect); return r_ans; }
SWIGEXPORT SEXP R_swig_dependency ( SEXP plugin) { char *arg1 = (char *) 0 ; unsigned int r_nprotect = 0;
  SEXP r_ans = R_NilValue ; VMAXTYPE r_vmax = vmaxget() ;
  arg1 = reinterpret_cast< char * >(SWIG_strdup(CHAR(STRING_ELT(plugin, 0)))); dependency(arg1); r_ans = R_NilValue; free(arg1);
