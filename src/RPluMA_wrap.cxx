...
R_swig_log ( SEXP msg)
{
  ...
  arg1 = reinterpret_cast< char * >(SWIG_strdup(CHAR(STRING_ELT(msg, 0))));
  log(arg1);
  r_ans = R_NilValue;
  free(arg1);
  vmaxset(r_vmax);
...
R_swig_dependency ( SEXP plugin)
{
  ...
  arg1 = reinterpret_cast< char * >(SWIG_strdup(CHAR(STRING_ELT(plugin, 0))));
  dependency(arg1);
  r_ans = R_NilValue;
  free(arg1);
  vmaxset(r_vmax);
