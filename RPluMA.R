...
attr(`log`, "inputTypes") = c('character')
...
`prefix` = function()
{
  ;.Call('R_swig_prefix', PACKAGE='RPluMA');
  
}

attr(`prefix`, 'returnType') = 'character'
class(`prefix`) = c("SWIGFunction", class('prefix'))

# Start of languageLoad

`languageLoad` = function(lang)
{
  lang = as(lang, "character"); 
  ;.Call('R_swig_languageLoad', lang, PACKAGE='RPluMA');
  
}

attr(`languageLoad`, 'returnType') = 'void'
attr(`languageLoad`, "inputTypes") = c('character')
class(`languageLoad`) = c("SWIGFunction", class('languageLoad'))

# Start of languageUnload

`languageUnload` = function(lang)
{
  lang = as(lang, "character"); 
  ;.Call('R_swig_languageUnload', lang, PACKAGE='RPluMA');
  
}

attr(`languageUnload`, 'returnType') = 'void'
attr(`languageUnload`, "inputTypes") = c('character')
class(`languageUnload`) = c("SWIGFunction", class('languageUnload'))
