...
XS(_wrap_dependency) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: dependency(plugin);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_languageLoad) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: languageLoad(lang);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_languageUnload) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: languageUnload(lang);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
...
{"PerlPluMAc::prefix", _wrap_prefix},
{"PerlPluMAc::languageLoad", _wrap_languageLoad},
{"PerlPluMAc::languageUnload", _wrap_languageUnload},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
